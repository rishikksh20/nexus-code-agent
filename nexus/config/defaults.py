...
class AgentConfig:
    ...
    agent_attached_tools: list[str] = field(default_factory=list)
    agent_detached_tools: list[str] = field(default_factory=list)
    agent_allowed_skills: list[str] = field(default_factory=list)
    agent_attached_skills: list[str] = field(default_factory=list)
    agent_detached_skills: list[str] = field(default_factory=list)
    agent_allowed_mcp_servers: list[str] = field(default_factory=list)
    agent_attached_mcp_servers: list[str] = field(default_factory=list)
    agent_detached_mcp_servers: list[str] = field(default_factory=list)
