...
from pydantic import BaseModel, ValidationError # For param validation only
import abc
...
class Tool(abc.ABC):
    ...
    def is_mutating(self, params: dict[str, Any]) -> bool:
        return self.kind in {ToolKind.SHELL, ToolKind.NETWORK, ToolKind.MEMORY, ToolKind.WRITE}


    async def get_confirmation(self, invocation: ToolInvocation) -> ToolConfirmation|None:
        # By default, non-mutating tools don't require confirmation, while mutating tools do.
