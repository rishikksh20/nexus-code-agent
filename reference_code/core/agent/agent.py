...
from core.client.datatype import StreamEventType, ToolCall, ToolResultMessage, TokenUsage
from core.tools.base import ToolConfirmation
from core.prompts.system import create_loop_breaker_prompt
...
class Agent:
    ...
    async def run(self, message: str) -> AsyncGenerator[AgentEvent, None]:
        ...
        yield AgentEvent.agent_stop(response=final_response, usage=None)
    ...
    async def _agentic_loop(self) -> AsyncGenerator[AgentEvent, None]:
        ...
        for turn_number in range(max_turns):
            ...
            if loop_detection_error:
                loop_breaker_prompt = create_loop_breaker_prompt(loop_detection_error)
